...
class AutoroleKDF:
    ...
    def __init__(self, bot):
        self.bot = bot
        self.file_path = "data/autoroleKDF/settings.json"
    ...
    @autoroleKDF.command(pass_context=True, no_pm=True)
...
def check_folders():
    if not os.path.exists("data/autoroleKDF"):
        print("Creating data/autoroleKDF folder...")
        os.makedirs("data/autoroleKDF")


def check_files():

    f = "data/autoroleKDF/settings.json"
