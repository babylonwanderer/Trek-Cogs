...
class Feeds(object):
    def __init__(self):
        ...
        self.feeds = fileIO("data/sto_news/feeds.json", "load")

    def save_feeds(self):
        fileIO("data/sto_news/feeds.json", "save", self.feeds)

    def check_folders(self):
        if not os.path.exists("data/sto_news"):
            print("Creating data/sto_news folder...")
            os.makedirs("data/sto_news")
        self.check_files()

    def check_files(self):
        f = "data/sto_news/feeds.json"
...
class sto_news(object):
    ...
    async def read_feeds(self):
        ...
        while self == self.bot.get_cog('sto_news'):
            feeds = self.feeds.get_copy()
            for server in feeds:
